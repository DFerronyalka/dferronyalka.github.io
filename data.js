...
const TIMELINE = [
  ...
  },
  {
    ...
    detail: "Mechanical Design & Fabrication Technician at AFNY Specialties, where I carried hardware from concept through installation for off-highway and commercial platforms. I designed SolidWorks assemblies ranging from single-piece brackets to 10–15 part mounts and suspension hardware engineered for high-vibration duty, producing the BOMs, drawings, and assembly notes that supported the build. Fabrication ran alongside design — CNC plasma (SheetCAM), press brake forming, and standardized threading on a FlexArm system — which kept every design accountable to what the shop could actually produce.",
  },
  {
